...
// 本地账号配置
const localAccounts = `15913145049#5201314LiPei
`;
...
const FTEJ_PK = ($.isNode() ? process.env.FTEJ_PK : $.getdata("FTEJ_PK")) || '1'; // 开启=1，关闭=0
const FTEJ_Lottery = ($.isNode() ? process.env.FTEJ_Lottery : $.getdata("FTEJ_Lottery")) || '1'; // 开启=1，关闭=0
