...
# 检查环境变量
print(f"WXPUSHER_APP_TOKEN: {os.getenv('WXPUSHER_APP_TOKEN')}")
print(f"WXPUSHER_UID: {os.getenv('WXPUSHER_UID')}")
...
def format_as_html_table(data, current_month):
    all_fees = {"0.5元话费", "1元话费-下午2点", "5元话费", "10元话费"}
    fee_order = ["0.5元话费", "1元话费-下午2点", "5元话费", "10元话费"]
